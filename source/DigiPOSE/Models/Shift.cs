...
namespace DigiPOSE.Models
{
    public class Shift
    {
        ...
        [Column(TypeName = "decimal(18, 2)")][Display(Name = "Start Cash")] public decimal StartCash { get; set; }
        [Column(TypeName = "decimal(18, 2)")][Display(Name = "End Cash")] public decimal? EndCash { get; set; }
