...
namespace DigiPOSE.Models
{
    public class Branch
    {
        ...
        [StringLength(255)][Display(Name = "Address")] public string Address { get; set; } = null!;
        [StringLength(50)][Display(Name = "Contact Phone")] public string ContactPhone { get; set; } = null!;
